...
pub const Exprs = struct {
    ...
    pub fn dumpInto(self: Expr, out_stream: var) OutStreamError(@TypeOf(out_stream)) ! void {
...
pub const SetExpr = struct {
    ...
    pub fn dumpInto(self: SetExpr, out_stream: var) OutStreamError(@TypeOf(out_stream)) ! void {
        try out_stream.writeAll("(");
        for (self.args) |arg| {
...
pub const BoolExpr = enum {
    ...
    Apply: Apply,
     ...
     pub fn dumpInto(self: BoolExpr, out_stream: var) OutStreamError(@TypeOf(out_stream)) ! void {
         switch (self) {
...
pub const Apply = struct {
    ...
    pub fn dumpInto(self: Apply, out_stream: var) OutStreamError(@TypeOf(out_stream)) ! void {
        try out_stream.writeAll("(");
...
pub const SetRef = enum {
    ...
    pub fn dumpInto(self: SetRef, out_stream: var) OutStreamError(@TypeOf(out_stream)) ! void {
        switch (self) {
            .Name => |name_ix| {
...
pub const ScalarRef = enum {
    ...
    pub fn dumpInto(self: ScalarRef, out_stream: var) OutStreamError(@TypeOf(out_stream)) ! void {
        switch (self) {
            .Name => |name_ix| {
                try std.fmt.format(out_stream, "S{}", name_ix.inner);
            },
